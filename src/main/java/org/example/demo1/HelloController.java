...
public class HelloController {
    ...
    void btnClick(ActionEvent event) {
        ...
        if (gameField[0][0] == gameField[0][1] && gameField[0][0] == gameField[0][2] && (gameField[0][0] == 'x' || gameField[0][0] == 'o')) {
           Alert alert = new Alert(Alert.AlertType.INFORMATION, "Победитель :" + btn.getText() + " Ура ", ButtonType.OK);
            alert.showAndWait();
            isGame = false;
        ...
        if (gameField[2][2] == gameField[1][1] && gameField[2][2] == gameField[0][2] && (gameField[2][2] == 'x' || gameField[0][0] == 'o')) {
            Alert alert = new Alert(Alert.AlertType.INFORMATION, "Победитель : Это " + btn.getText() + " Ура ", ButtonType.OK);
            alert.showAndWait();
            isGame = false;
        }
        if (gameField[2][0] == gameField[1][1] && gameField[2][0] == gameField[0][2] && (gameField[2][0] == 'x' || gameField[0][0] == 'o')) {
            Alert alert = new Alert(Alert.AlertType.INFORMATION, "Победитель :" + btn.getText() + " Ура ", ButtonType.OK);
            alert.showAndWait();
            isGame = false;
        }
